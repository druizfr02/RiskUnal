...
def mostrarMapa():
  ...
  if mapa=="si" or mapa== "Si":
    ...
    ventana.mainloop()
#######################################################################################################################################################################################################################################################################
EquipoAdministrativos={101:"Torre de enfermería"}
EquipoArtes={305:"Conservatorio"}
...
mapaGeneral=[territoriosAdministrativos,territoriosArtes]

global totalLugares
totalLugares=len(EquipoAdministrativos)+len(EquipoArtes)

totalLugares2=len(EquipoAdministrativos)+len(EquipoArtes)
